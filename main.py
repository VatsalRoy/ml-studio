...
# ---------------------------------#
# Page layout
st.set_page_config(page_title=' Interactive ML Studio - Random Forest Regression ',
                   layout='wide')
...
## 🚀 What You Can Do:
- **Upload your CSV data** or use our example dataset
- **Tune model parameters** with interactive sliders
- **See real-time results** including accuracy metrics and performance scores
- **Experiment freely** - perfect for learning and prototyping!

## 📊 How It Works:
Random Forest creates multiple decision trees that work together like a committee to make more accurate predictions than any single model could achieve alone.

**Ready to start?** Upload your data or try the example dataset below!
